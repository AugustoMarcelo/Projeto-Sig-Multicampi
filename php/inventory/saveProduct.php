<?php
	...
	if ($id ==  0) { //create
		$insertQuery = "INSERT INTO product (nome, codigo, quantidade, quantidadeMin, Sigla_id, tipoMaterial, descricao, ";//) ";
		if ($_FILES['picture']['size'] != 0) {
			$insertQuery .= "picture, ";
		}
		$insertQuery .= "dataCadastro)";
		$insertQuery .= "VALUES ('$name', '$codigo', '$quantidade', '$quantidadeMin', '$sigla', '$material', '$descricao', ";//'$dataCadastro')";
		if ($_FILES['picture']['size'] != 0) {
		...
		$updateQuery .= "tipoMaterial = '$material', ";
